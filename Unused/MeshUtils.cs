...
{
    private static readonly Vector3 m_vector3Zero = Vector3.zero;
    private static readonly Vector3 m_vector3One = Vector3.one;
    private static readonly Vector3 m_vector3DownY = new Vector3(0, -1);
    ...
    {
        int rotation = Mathf.RoundToInt(rotFloat);
        rotation %= 360;
